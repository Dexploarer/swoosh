...
public struct ExperimentalFlags {
  private nonisolated(unsafe) static var optedIn = false
  ...
  private nonisolated(unsafe) static var _enableBenchmark: Bool = false
  ...
  private nonisolated(unsafe) static var _convertCamelToSnakeCaseInToolDescription: Bool = true
  ...
  private nonisolated(unsafe) static var _enableConversationConstrainedDecoding: Bool = false
  ...
  private nonisolated(unsafe) static var _enableSpeculativeDecoding: Bool? = nil
  ...
  private nonisolated(unsafe) static var _visualTokenBudget: Int32? = nil
