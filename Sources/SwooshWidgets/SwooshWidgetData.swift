    ...
    public static var preview: SwooshWidgetSnapshot {
        SwooshWidgetSnapshot(
            providers: [
                ...
                WidgetProviderStatus(providerID: "anthropic", displayName: "Anthropic",
                                     sourceKind: "KEY", credentialKind: "oauthToken",
                                     usagePercent: 0.72, usageLabel: "72%",
                                     resetLabel: "Resets in 1h 30m", costLabel: "$8.10"),
                WidgetProviderStatus(providerID: "gemini", displayName: "Gemini",
                                     sourceKind: "FILE", credentialKind: "oauthToken",
                                     usagePercent: 0.18, usageLabel: "18%"),
                WidgetProviderStatus(providerID: "deepseek", displayName: "DeepSeek",
                                     sourceKind: "ENV", credentialKind: "apiKey",
                                     usagePercent: 0.90, usageLabel: "90%",
                                     resetLabel: "Resets in 15m", costLabel: "$1.05"),
                WidgetProviderStatus(providerID: "groq", displayName: "Groq",
                                     sourceKind: "ENV", credentialKind: "apiKey",
                                     usagePercent: 0.30, usageLabel: "30%"),
            ],
            pendingApprovals: 3,
            activeAgents: 2,
            activeBoardCards: 7,
